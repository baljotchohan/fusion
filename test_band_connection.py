...
def test_band_connection_setup():
    """Verify that imports work, agent_config is valid, and Agent can be instantiated."""
    from thenvoi import Agent
    from thenvoi.core.simple_adapter import SimpleAdapter
    ...
    assert AGENT_ID != "get-from-band-dashboard"
    assert API_KEY != "get-from-band-dashboard"
    ...
    assert agent.runtime.agent_id == AGENT_ID
    assert agent.runtime._api_key == API_KEY
